...
import { useGetWinnerNameAndScore, useGuessedPreviously,useGuessNumber } from '@/hooks/useSurvivor';
      ...
      <section className='bg-white'>
        <div className='layout relative flex min-h-screen flex-col items-center justify-center py-12 text-center'>
          ...
          <form className='flex flex-col gap-4 items-center w-full'>
            ...
            <span>Guess any number between 1 and 1000, the game will then randomly generate a number between 1 and 1000. Whoever has the smallest difference between the 2 wins. P.S the random number changes every turn.</span>
            </div>
          </form>
          </div>
